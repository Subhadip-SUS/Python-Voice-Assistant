...
def textField():
    ...
    #         global meaw
    #         meaw = "It's Late Night Sir!, You should sleep right now"
    #         root.update()

    #     elif hour>=4 and hour<12:
    #         speak("Good Moring Master!")
    #         meaw = "Good Moring Master!"
    #     elif hour>=12 and hour<17:
    #         speak("Good Afternoon Sir !")
    #         meaw = "Good Afternoon Sir !"
    ...
    #         meaw = "I am Your Personal assistant, Jarvis! version 1.2! With the power of 8 gigabytes of ram, along with GPU and SSD"
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            meaw = 'Searching in Wikipedia'
            root.update()
            query = query.replace("according to wikipedia","")
            results=wikipedia.summary(query, sentences=2)
            speak("Accoring to Wikipedia")
            meaw = "Accoring to Wikipedia"
            print(results)
            meaw = results
            root.update()
            speak(results)
